...
public class AnnotationJbehaveSteps {
	...
	public void beforeStory() {     
        System.out.println("#####Automation Jbehave Start#####");
	...
	public void user_is_on_Ultimatix_Home_Page() throws Throwable {
		//Launch the Ultimatix Website
		driver.get("https://www.ultimatix.net");
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	}

	@When("User enters valid <UserName>")
	//@Aliases(values={"User enters valid UserName $UserName"})// standalone                 
	...
	//@Aliases(values={"User enter valid Password $Password"}) // standalone
